...
!define MULTIUSER_INSTALLMODE_INSTDIR "42ptr calc"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\42ptr calc.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\42ptr_calc.launch.pyw"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\42ptr_calc.launch.pyw"
    Delete "$INSTDIR\glossyorb.ico"
    Delete "$INSTDIR\LICENSE"
    Delete "$INSTDIR\README.md"
    Delete "$desktop\42ptr calc.lnk"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"
    RMDir /r "$INSTDIR\resources"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\42ptr calc.lnk"
  RMDir $INSTDIR
...
Function finishpageaction
    CreateShortCut "$desktop\42ptr calc.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\42ptr_calc.launch.pyw"' "$INSTDIR\glossyorb.ico"
